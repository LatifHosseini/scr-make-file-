...
set OUT_FILEPATH=..\..\build\ScrPrgCode.c
...
rem *****************************************************************************
rem * create SCR-program c-array image from elf-file, referenced by clients
rem *****************************************************************************
if %ERRORLEVEL% == 0 (
  echo Generating %OUT_FILEPATH%
  SCR_ImageDump.exe ..\..\build\CEIC_SCR.elf ..\..\build >SCR_ImageDump.log
