...
-----------------------------------------------------------------------------------------------------------------------
 ...
 ----------------------------------------------------------------------------------------------------------------------
  ...
  01.09.01  2018-11-16  visbwa  Implemented Default_Init_Tasks for projects with up to 6 Cores,
...
#endif
#if (BRSASRMAIN_BUGFIX_VERSION != 0x01u)
...
//volatile uint32 exchangeB[4]         __at(0x37);//0x30
/**********************************************************************************************************************
...
/**********************************************************************************************************************
  LOCAL VARIABLES
**********************************************************************************************************************/
/* PRQA S 5087 LABEL_5087 */ /* MD_MSR_MemMap */
...
TASK(Default_Init_Task)
{
  ...
  (void)TerminateTask();  /* PRQA S 2880 */ /* MD_MSR_14.1 This code should never reach here */
}
...
static void BrsAsrMainCyclic1ms(void)
{
  ...
  if ((wBrsMainCallCounter1ms % 10u) == 0u)
  {
    Scr10msTask ();
  ...
  if ((wBrsMainCallCounter1ms % 50u) == 5u)	// 50ms_task has an offset of 5ms to 10ms_task
  {
    Scr50msTask ();
...
/*
  if (wBrsMainCallCounter1ms % 500==0)
  {
	static uint32 tmp=0;
 ...
 */
/*****************************************************************************/
void BrsMainExceptionHandler(uint8 ErrorCode, uint8 ModuleCode, uint16 LineNumber) /* PRQA S 3206 */ /* Function parameter not used, because not neede  fom actual SW configuration   */
{
